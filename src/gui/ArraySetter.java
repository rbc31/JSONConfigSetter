...
public class ArraySetter extends JPanel implements ISetter {
	...
	public ArraySetter(Data data, Font font, JFrame parent, JSONConfig config) {
		super();
